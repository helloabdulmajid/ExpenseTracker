...
@Entity @Table(name = "income_categories", indexes = {
    @Index(name = "idx_inc_cat_user_id", columnList = "user_id")
}, uniqueConstraints = {
    @UniqueConstraint(name = "uk_inc_cat_user_name", columnNames = {"user_id", "category_name"})
})
...
public class IncomeCategory extends BaseEntity {
    ...
    private User user;
    public IncomeCategory(String categoryName, boolean defaultCategory, User user) {
